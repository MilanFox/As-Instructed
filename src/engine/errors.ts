...
export const FailureCode = {
  ...
  Compile: 'compile',
  /** A bot ran dry. DESIGN.md §11 A1. */
  OutOfFuel: 'out-of-fuel',
  /** Every bot in a multi-bot level blocked every other, indefinitely. DESIGN.md §11 A6. */
  BlockedLivelock: 'blocked-livelock',

  /**
   * DESIGN.md §11 spells these two in SCREAMING_CASE. Aliases so either name compiles; the
