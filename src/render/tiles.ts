...
const BIOMES: Readonly<Record<Biome, BiomeArt>> = {
  ...
  yard: {
    floors: ['floor.concrete', 'floor.concrete', 'floor.concrete', 'floor.concrete.b'],
    accents: ['floor.concrete.b'],
    accentRate: 0,
  ...
  grid: {
    floors: ['floor.metal', 'floor.metal'],
    accents: ['floor.metal.dot'],
    accentRate: 0.08,
  ...
  swarm: {
    floors: ['floor.concrete.b', 'floor.concrete', 'floor.concrete.b', 'floor.concrete'],
    accents: ['floor.concrete.b'],
    accentRate: 0,
