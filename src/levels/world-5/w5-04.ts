...
export const w5_04: LevelDef = {
  ...
  brief: [
    ...
    '',
    'Every consumer in Yard 4 needs a feeder and every feeder has a ceiling. The ceilings',
    'are defined in Appendix C. The index entry for Appendix C is a reference to Appendix C.',
    'I have requested a copy of that.',
    '',
    ...
    '  upward and report `vars.draw`. `probe(id)` reads either, for free, and returns `null` for',
  ...
  starter: [
    '// feeder-1 upward report vars.capacity. consumer-1 upward report vars.draw.',
    '// link(feederId, consumerId) puts a consumer on a feeder and cannot be undone.',
    '// Every consumer ends on exactly one feeder.',
    '',
    'const feeders = [];',
    'for (let i = 1; ; i++) {',
