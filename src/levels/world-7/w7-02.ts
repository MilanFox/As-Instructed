...
export const w7_02: LevelDef = {
  ...
  brief: [
    ...
    '',
    'If you published a routing helper to your library, you can import it here. If you did not,',
    'write one in this file; nothing in this work order depends on having done it earlier.',
    '',
