...
export const w6_03: LevelDef = {
  ...
  brief: [
    ...
    'the invoice and nothing else. the field either side of the route is pits, and RIG-06 will',
    'drive into one if you tell it to.',
    '',
    'One packet is waiting on the band. It is the route from the tile you are standing on to the',
    'landing pad, enciphered.',
    '',
    '`decode(text, key)` returns the plain text and costs nothing. The key changes between',
    "shifts. Read it for free with `probe('mast').vars.key`.",
    '',
    'The decoded route is a list of groups run together with nothing between them, like',
    '`4E12S1W`. A group is a count followed by a direction letter. The count is a decimal number',
    'of one or more digits. The direction is one of `N`, `E`, `S`, `W`. The same direction may',
    'appear in two groups in a row.',
    '',
    'Drive the route and park on the pad. Every tile off the route is a pit, and a bot that',
    'steps into one does not come back.',
    '',
    ...
    '',
    '**The Repository.** Nothing here needs it. But this format is not a one-off — it is the',
    'station format, and it turns up twice more before the Contract closes, once inside a much',
    'larger grammar and once in an eleven-month-old survey. The half of your program that turns',
    '`4E12S1W` into the moves it stands for is worth keeping when this work order closes. Later',
    'briefs call it `unpack`.',
  ].join('\n'),
  seeds: [1, 2, 3, 4],
  ...
  starter: [
    '// One packet is waiting: the route from here to the pad, enciphered.',
    '// The key is on the antenna. Everything off the route is a pit.',
    '',
