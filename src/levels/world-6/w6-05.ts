...
export const w6_05: LevelDef = {
  ...
  brief: [
    ...
    '',
    '**The Repository.** This work order assumes a `findKey(packets)` in `lib.ts`: something',
    'that takes the traffic and returns the shift it was sent with. Import it with',
    "`import { findKey } from 'lib';`. If it is not in there, write it in this file — nothing",
    'here depends on its having been published.',
  ].join('\n'),
  seeds: [1, 2, 3, 4, 5],
