...
export const w6_04: LevelDef = {
  ...
  brief: [
    ...
    '  text, at position 0. That does not change between shifts.',
    '',
    'Transmit the plain text of every headed packet, whole and in order, and transmit nothing',
    'else before them. `transmit()` costs one tick.',
    '',
    '**Extra objective.** The last packet came in through the old repeater. It has no header and',
    'a **different** shift in the same range. Transmit its plain text after the others.',
    '',
    '**The Repository.** Nothing here needs it. But procurement did not buy the cipher for the',
    'north workings either. Three later work orders hand you a shifted band and no key. Keep',
    'the search; later briefs call it `findKey`.',
  ].join('\n'),
  seeds: [1, 2, 3, 4],
