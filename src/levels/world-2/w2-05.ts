...
export const w2_05: LevelDef = {
  ...
  brief: [
    ...
    'which likes the same soil, reads the same on the sensor except for the kind, and is',
    'worth nothing to anybody. the hopper still does not open. whatever you pick up, you',
    'are keeping.',
    '',
    ...
    '',
    `The shift ends after **${String(SHIFT)} ticks** and the field is far longer than that.`,
    'Crossing all of it is not part of the job.',
  ].join('\n'),
  seeds: [1, 2, 3, 4, 5],
