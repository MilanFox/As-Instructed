...
export const w2_01: LevelDef = {
  ...
  brief: [
    ...
    'which makes it the only free thing on this site. bay 9 has one row in it. before i',
    'calibrate anything i need to know which plant is furthest along.',
    '',
    'Drive along the row and **park the bot on the crop with the highest `growth` reading.**',
    'Exactly one tile has the highest reading.',
    '',
  ...
  starter: [
    ...
    '// Both are free, so read as often as you like.',
    '',
    'const here = scan();',
