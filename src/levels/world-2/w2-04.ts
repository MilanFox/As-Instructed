...
export const w2_04: LevelDef = {
  ...
  brief: [
    ...
    'confirmed this is a feature and have declined to say of what. A hopper with no room in',
    'it cannot take a crop, and the arm swings anyway.',
    '',
    'The north plot is six tiles. **Every crop in it must be harvested once, and every tile',
    'must be left planted.**',
    '',
    'The hopper is full when the shift starts, so there is no room for a crop until a seed',
    'has gone into the ground. `inventory()` reports what the bot is carrying right now, and',
    'it is the only instrument that reports the hopper at all.',
    '',
    'The crops ripen at different times. Growth climbs by one every tick, so a tile reading',
