...
export const w2_02: LevelDef = {
  ...
  brief: [
    ...
    'concern in 2210 and the concern was filed. Part of the field is ready. The rest is not,',
    'and will not be today.',
    '',
    ...
    'north-west corner. `harvest()` costs two ticks whether or not it finds anything, so the',
    'free sensor is worth using first. Bare soil reports `crop: null` with `growth: 0` of',
