...
export const w1_03: LevelDef = {
  ...
  brief: [
    ...
    'somewhere between eight and twenty-six tiles. i am not walking it for you.',
    '',
    'Drive East along the corridor and park on the landing pad at the end of it.',
    '',
    'The corridor is a different length every shift, so a counted loop that works on one',
    'shift will overshoot or stop short on the next. `canMove(Dir.East)` reports whether',
    'the next tile East is clear. Asking costs nothing; bumping into the wall costs a tick.',
  ].join('\n'),
  seeds: [1, 4, 7],
  ...
  starter: [
    ...
    '',
    '// canMove(Dir.East) is free, and true only while the next tile East is clear.',
    '',
    'move(Dir.East);',
    '',
  ].join('\n'),
