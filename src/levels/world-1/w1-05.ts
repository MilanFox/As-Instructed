...
export const w1_05: LevelDef = {
  ...
  brief: [
    ...
    'measure anything. It produces a figure, and the figure is filed. Facilities have',
    'confirmed the figure is required.',
    '',
    ...
    'so no fixed leg length will sweep it.',
  ].join('\n'),
  seeds: [1, 2, 6, 8],
  ...
  starter: [
    ...
    '',
    '// Sweep one row: drive East while canMove(Dir.East) says there is more row.',
    '// Then drop South and come back the other way.',
    '',
  ].join('\n'),
  hints: [
