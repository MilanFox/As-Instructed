...
export const w4_04: LevelDef = {
  ...
  brief: [
    ...
    '',
    'This is three jobs and they are cheaper apart than together.',
    '',
    '1. **Survey.** Drive around and write down what the bot sees: which tiles are floor, which',
    '   are solid, and which tile touches which.',
    '2. **Plan.** With the survey written down and the bot standing still, work out the order to',
    '   take the three collection points and the route between them.',
    '3. **Run.** Walk that route once.',
    '',
    'The tick budget pays for looking around once and for one good circuit. It does not pay for',
    'three separate trips.',
    '',
    '**The Repository.** Nothing in this work order needs it. But the two halves you are about',
    'to write — the one that records what the bot can see, and the one that walks it to a tile',
    'the record already knows — are the two halves the rest of the campaign keeps asking for.',
    'When this work order closes you will be offered the chance to keep them. Later briefs call',
    'them `survey` and `pathTo`.',
  ].join('\n'),
  seeds: [1, 2, 3, 4],
