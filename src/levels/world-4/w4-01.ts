...
export const w4_01: LevelDef = {
  ...
  brief: [
    ...
    'first, stopping at the first thing it cannot see through. It costs nothing and it may be',
    'called as often as you like. The tunnel is a different shape every shift, so the route has',
    'to be read rather than written.',
    '',
    '### Memory',
    '',
    'Stated plainly, because the rest of this world depends on it. Ordinary JavaScript values —',
    'objects, arrays, `Map`, `Set`, closures — hold their contents for the whole run. Nothing is',
    'cleared between moves. The bot forgets nothing your program chose to write down.',
    '',
    'The hardware installed two work orders from now, `mark` and `readMark`, is not for that. It',
    'writes state into the **world**, onto a tile, where a second pass or a second bot can read',
    'it back.',
  ].join('\n'),
  seeds: [1, 2, 3],
  ...
  starter: [
    '// The tunnel bends. It never forks and it never loops back.',
