...
export const w8_02: LevelDef = {
  ...
  brief: [
    ...
    'happen at once.',
    '',
    'Routing helpers you have already published can be imported here, and anything you have not',
    'published you can write in this file; nothing in this work order depends on having written',
    'it earlier.',
  ].join('\n'),
  seeds: [1, 2, 3, 4, 5],
