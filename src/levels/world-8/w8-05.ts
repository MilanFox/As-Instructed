...
const BRIEF = [
  ...
  'everything in order.',
  '',
  'The work order expects you to reuse your own published routines — routing,',
  'sweeping, decoding, scheduling. In particular it assumes a `findKey(packets)` in',
  '`lib.ts`: something that takes the traffic and returns the shift it was sent with.',
  "Import it with `import { findKey } from 'lib';`. If it is not in there, write it in",
  'this file — nothing in this work order depends on your having published it earlier.',
  '',
