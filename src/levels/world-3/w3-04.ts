...
export const w3_04: LevelDef = {
  ...
  brief: [
    ...
    '```',
    '',
    'Every crate in the racks has an arrival number stencilled on its slot, counting up from 1',
    'with no gaps. `scan(dir).mark` reads the stencil and returns it as a string, or `null` on',
    'an unpainted tile.',
    '',
