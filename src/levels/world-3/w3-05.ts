...
export const w3_05: LevelDef = {
  ...
  brief: [
    ...
    '',
    'The rack holds a different number of crates every shift. `inventory()` returns how many',
    'items the bot is holding. A `pickup()` on a full rack takes nothing, returns 0, and still',
    'costs a tick.',
  ].join('\n'),
  seeds: [1, 2, 3, 4, 5],
