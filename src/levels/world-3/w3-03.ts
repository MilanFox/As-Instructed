...
export const w3_03: LevelDef = {
  ...
  brief: [
    ...
    'manifest line, including anything printed while you were debugging, so take those out',
    'before you submit.',
    '',
    'Then operate the manifest terminal until it reads `filed`. The terminal stands on one of',
    'the four aisle heads — the painted pads at either end of each aisle.',
  ].join('\n'),
  seeds: [1, 2, 3, 4],
